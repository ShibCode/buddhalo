          ...
          <div className="home__section4Questions">
            ...
            <div className="home__section4Question">
              ...
              <div className="home__section4QuestionRight">
                ...
                <p className="home__para">
                  您可以在您所在地区或者在线搜索符合您能量特型音乐或者曼陀罗，还有持有halo的伙伴们，您将在我们Web3元宇宙共同寻找灵感，我们将为您制作和呈现出来。
                </p>
              </div>
            </div>
            ...
            <div className="home__section4Question">
              ...
              <div className="home__section4QuestionRight">
                ...
                <p className="home__para">
                  为什么要为手中的宝物真溯源而烦恼呢？我们制作的NFT是独特且唯一可识别的！你也想为您的宝物制作独一无二的身份代码？我们机构同样可以为您服务，为了让您快速发现同频率同层次的好友，我们将会为大家建立并且提供一个Web3元宇宙。
                </p>
              </div>
            </div>
